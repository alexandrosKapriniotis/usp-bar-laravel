...
return [
    ...
    */
    ...
    'app_name' => env('SHOPIFY_APP_NAME', 'Usp Bar 2'),
    ...
    */
    ...
    'api_key' => env('SHOPIFY_API_KEY', 'e21a1b44e7a01105d5f2d313a6562532'),
    ...
    */
    ...
    'api_secret' => env('SHOPIFY_API_SECRET', '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'),
    ...
    */
    ...
    'api_scopes' => env('SHOPIFY_API_SCOPES', 'read_themes,write_themes,read_products,write_products,read_script_tags,write_script_tags'),
    ...
    */
    ...
    'webhooks' => [
        [
            ...
            'address' => env('SHOPIFY_WEBHOOK_1_ADDRESS', 'https://sandbox.waterfront.digital/webhook/app-uninstalled')
        ],
        /*
            [
    ...
    */
    ...
    'scripttags' => [
        [
            'src' => env('SHOPIFY_SCRIPTTAG_1_SRC', 'https://sandbox.waterfront.digital/js/usp_bar.js'),
